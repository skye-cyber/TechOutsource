...
if (isset($_POST["apply"]) && $msg == "") {
    ...
    move_uploaded_file($_FILES['cv_file']['tmp_name'], "files/" . $cv_file);


    $stmt = $conn->prepare("INSERT INTO apply (f_username, job_id, bid,cv,cover_letter) VALUES (?, ?, ?, ?,?)");

    $stmt->bind_param("sidss",  $username, $job_id, $bid, $cv_file, $cover,);
    ...
    $stmt->close();
    // $sql = "INSERT INTO apply (f_username, job_id, bid, cv, cover_letter) VALUES ('$username', '$job_id', '$bid' ,'$cv','$cover')";
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <form id="registrationForm" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Attach a CV</label>
                        <div class="col-sm-8">
